...
import { createCategoryController, deletCategoryController, getAllCategoriesController } from "../controller/categoryController.js";
...
// delete Task details
userRoute.delete("/deletecategory/:id", deletCategoryController);
